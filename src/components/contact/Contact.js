        ...
        <div className={styles.cardWrapper}>
          ...
          >
            ...
            <ul className={styles.contactInfoCardList}>
              ...
              <li className={styles.contactInfoCardListItem}>availability</li>
          ...
          <div className={styles.contactCard}>
            ...
            <div className={styles.textBlockWrapper}>
              <div className={styles.iconWrapper}>
                ...
                <a href="tel:+1-204-232-2967" className={styles.contactLink}>
                  (204)-232-2967
                </a>
              </div>
            </div>
            ...
            <div className={styles.secondaryMediaSection}>
              ...
              <div className={styles.secondaryLogoBlock}>
                ...
                >
                  <IoLogoDribbble className={styles.secondaryContactIcon} />
                </a>
                <a
